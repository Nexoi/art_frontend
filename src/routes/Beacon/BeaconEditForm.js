...
export default class BeaconEditForm extends PureComponent {
  ...
  handleSubmit = (e) => {
    ...
    this.props.form.validateFieldsAndScroll((err, values) => {
      if (!err) {
        ...
        if ((parseInt(height, 10) < 0 || parseInt(width, 10) < 0) && this.state.sourceData.showMap === undefined) {
  ...
  render() {
    ...
    const modalMapSelector = (
      ...
      >
        <ShowMapSelector
          showId={this.state.sourceData.showId}
        ...
        >
          ...
          >
            {getFieldDecorator('name', {
              ...
              initialValue: this.state.sourceData.name || '未命名',
            })(
          ...
          >
            {getFieldDecorator('uuid', {
              ...
              initialValue: this.state.sourceData.basicInfo.uuid,
            })(
              <Input disabled placeholder="12345678-abcd-88cc-1111aaaa2222" />
            )}
          </FormItem>
          <FormItem
            {...formItemLayout}
          ...
          >
            {getFieldDecorator('majorValue', {
              ...
              initialValue: this.state.sourceData.basicInfo.majorValue,
            })(
              <InputNumber disabled placeholder="8000" />
            )}
          </FormItem>
          <FormItem
            {...formItemLayout}
          ...
          >
            {getFieldDecorator('minorValue', {
              ...
              initialValue: this.state.sourceData.basicInfo.minorValue,
            })(
              <InputNumber disabled placeholder="8000" />
            )}
          </FormItem>
            ...
            {getFieldDecorator('map')(
              <div>
                ...
                { this.state.selectedMap.id === -1
                  ? (<div> {this.state.sourceData.showMap === undefined ? '' : `${this.state.sourceData.showMap.name}`} </div>)
